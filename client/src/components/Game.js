          ...
          {gameOver ? (
            ...
            <div>
              ...
              {currentUser === "Player 1" && (
                <Player1View
                cardPlayedHandler={cardPlayedHandler} p2Cards={p2Cards} activePlayer={activePlayer} p1Cards={p1Cards} fullname={fullname} drawCardHandler={drawCardHandler} info={info} playedCard={playedCard}
                />
              )}
